...
export class TodoListsClient implements ITodoListsClient {
    ...
    createEmployee(command: CreateEmployeeCommand): Observable<number> {
        let url_ = this.baseUrl + "/api/TodoLists/Employee";
        url_ = url_.replace(/[?&]$/, "");
...
export interface IToolClient {
    createEmployee(command: CreateToolCommand): Observable<string>;
}

@Injectable({
    providedIn: 'root'
})
export class ToolClient implements IToolClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    createEmployee(command: CreateToolCommand): Observable<string> {
        let url_ = this.baseUrl + "/api/Tool";
        url_ = url_.replace(/[?&]$/, "");
...
export class CreateToolCommand implements ICreateToolCommand {
    toolId?: number;
    toolName?: string | undefined;
    description?: string | undefined;

    constructor(data?: ICreateToolCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateToolCommand {
        data = typeof data === 'object' ? data : {};
        let result = new CreateToolCommand();
        result.init(data);
        return result;
    }
...
export interface ICreateToolCommand {
    toolId?: number;
    toolName?: string | undefined;
    description?: string | undefined;
}
